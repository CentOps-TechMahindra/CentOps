...
public class ViewFeedbackAJAX extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			records		= fDao.getAllClosedFeedbackCount();									//fDTOList.size();
			total		= (int) Math.ceil((double)records / rows);									//records/rows;
			fDTOList	= fDao.getAllClosedFeedback(upperLimit, offset, sidx, sord);
        	...
        	logger.error("Error in ViewFeedbackAJAX.doPost()!"+e.getMessage());
    		try {
