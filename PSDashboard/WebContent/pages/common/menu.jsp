	...
	<body>
		<nav class = "navbar navbar-default" role = "navigation" style="background-color: #f8f8f8; height:15px;">
		      ...
		      <ul class = "nav navbar-nav">
				   	<li><a href="#" class="indicator glyphicon glyphicon-home  pull-left" id="homeBtnId"></a></li>
					
					<li class="dropdown" style="">
			            <a id="dLabel" role="button" data-toggle="dropdown" class=" glyphicon glyphicon-menu-hamburger" data-target="#" href="/page.html"></a>
